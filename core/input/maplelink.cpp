...
void MapleLinkVmu::serialize(Serializer& ser) const {
...
MapleLink::Ptr MapleLinkVmu::getMapleLink()
{
...
MapleDeviceRV MapleLinkVmu::readBlock(unsigned block)
{
