...
*/
u32 maple_sega_controller::get_capabilities() {
...
u16 maple_sega_controller::getButtonState(const PlainJoystickState &pjs)
{
	u32 kcode = pjs.kcode;
...
u32 maple_sega_controller::getAnalogAxis(int index, const PlainJoystickState &pjs)
{
	if (index == 2 || index == 3)
	{
...
MapleDeviceType maple_sega_controller::get_device_type()
{
	return MDT_SegaController;
}

const char *maple_sega_controller::get_device_name()
{
	return maple_sega_controller_name;
}

const char *maple_sega_controller::get_device_brand()
{
	return maple_sega_brand;
}

u32 maple_sega_controller::get_device_current(int get_max_current)
{
	return get_max_current ? 0x01F4 : 0x01AE; // Max. 50 mA, standby: 43 mA
}

u32 maple_sega_controller::dma(u32 cmd)
{
...
/*
	Atomiswave Controller
*/
u32 maple_atomiswave_controller::get_capabilities() {
	// byte 0: 0  0  0  0  0  0  0  0
	// byte 1: 0  0  a5 a4 a3 a2 a1 a0
	// byte 2: R2 L2 D2 U2 D  X  Y  Z
	// byte 3: R  L  D  U  St A  B  C
...
u16 maple_atomiswave_controller::getButtonState(const PlainJoystickState &pjs)
{
	u32 kcode = pjs.kcode;
...
u32 maple_atomiswave_controller::getAnalogAxis(int index, const PlainJoystickState &pjs) {
	if (index < 2 || index > 5)
		return 0x80;
	index -= 2;
...
*/
u32 maple_sega_twinstick::get_capabilities() {
	// byte 0: 0  0  0  0  0  0  0  0
	// byte 1: 0  0  a5 a4 a3 a2 a1 a0
	// byte 2: R2 L2 D2 U2 D  X  Y  Z
	// byte 3: R  L  D  U  St A  B  C
...
u16 maple_sega_twinstick::getButtonState(const PlainJoystickState &pjs)
{
	u32 kcode = pjs.kcode;
	mutualExclusion(kcode, DC_DPAD_UP | DC_DPAD_DOWN);
	mutualExclusion(kcode, DC_DPAD_LEFT | DC_DPAD_RIGHT);
...
MapleDeviceType maple_sega_twinstick::get_device_type() {
	return MDT_TwinStick;
}

u32 maple_sega_twinstick::getAnalogAxis(int index, const PlainJoystickState &pjs) {
	return 0x80;
}

const char *maple_sega_twinstick::get_device_name() {
	return maple_sega_twinstick_name;
}

u32 maple_sega_twinstick::get_device_current(int get_max_current) {
...
*/
u32 maple_ascii_stick::get_capabilities() {
	// byte 0: 0  0  0  0  0  0  0  0
	// byte 1: 0  0  a5 a4 a3 a2 a1 a0
	// byte 2: R2 L2 D2 U2 D  X  Y  Z
	// byte 3: R  L  D  U  St A  B  C
...
u16 maple_ascii_stick::getButtonState(const PlainJoystickState &pjs)
{
	u32 kcode = pjs.kcode;
	mutualExclusion(kcode, DC_DPAD_UP | DC_DPAD_DOWN);
	mutualExclusion(kcode, DC_DPAD_LEFT | DC_DPAD_RIGHT);
...
MapleDeviceType maple_ascii_stick::get_device_type() {
	return MDT_AsciiStick;
}

u32 maple_ascii_stick::getAnalogAxis(int index, const PlainJoystickState &pjs) {
	return 0x80;
}

const char *maple_ascii_stick::get_device_name() {
	return maple_ascii_stick_name;
}

u32 maple_ascii_stick::get_device_current(int get_max_current) {
...
void maple_sega_vmu::serialize(Serializer& ser) const
{
...
void maple_sega_vmu::initializeVmu()
{
...
const void *maple_sega_vmu::getData(size_t& size) const
{
...
/*
	Microphone
*/
maple_microphone::~maple_microphone()
{
	if (sampling)
		StopAudioRecording();
}
MapleDeviceType maple_microphone::get_device_type()
{
	return MDT_Microphone;
}

void maple_microphone::serialize(Serializer& ser) const
{
	maple_base::serialize(ser);
	ser << gain;
	ser << sampling;
...
void maple_microphone::deserialize(Deserializer& deser)
{
	if (sampling)
		StopAudioRecording();
	maple_base::deserialize(deser);
...
u32 maple_microphone::dma(u32 cmd)
{
	switch (cmd)
	{
	case MDC_DeviceRequest:
...
/*
	Puru Puru Pack
*/
MapleDeviceType maple_sega_purupuru::get_device_type()
{
	return MDT_PurupuruPack;
}

void maple_sega_purupuru::serialize(Serializer& ser) const
{
	maple_base::serialize(ser);
	ser << AST;
	ser << AST_ms;
...
void maple_sega_purupuru::deserialize(Deserializer& deser)
{
	maple_base::deserialize(deser);
	deser >> AST;
	deser >> AST_ms;
...
u32 maple_sega_purupuru::dma(u32 cmd)
{
	switch (cmd)
	{
	case MDC_DeviceRequest:
...
/*
	Keyboard
*/
MapleDeviceType maple_keyboard::get_device_type()
{
	return MDT_Keyboard;
}

u32 maple_keyboard::dma(u32 cmd)
{
	switch (cmd)
	{
	case MDC_DeviceRequest:
...
/*
	Mouse
*/
MapleDeviceType maple_mouse::get_device_type()
{
	return MDT_Mouse;
}

u16 maple_mouse::mo_cvt(int delta)
{
	return (u16)std::min(0x3FF, std::max(0, delta + 0x200));
}

u32 maple_mouse::dma(u32 cmd)
{
	switch (cmd)
	{
	case MDC_DeviceRequest:
...
/*
	Lightgun
*/
u32 maple_lightgun::transform_kcode(u32 kcode)
{
	mutualExclusion(kcode, DC_DPAD_UP | DC_DPAD_DOWN);
	mutualExclusion(kcode, DC_DPAD_LEFT | DC_DPAD_RIGHT);
...
MapleDeviceType maple_lightgun::get_device_type()
{
	return MDT_LightGun;
}

u32 maple_lightgun::dma(u32 cmd)
{
	switch (cmd)
	{
	case MDC_DeviceRequest:
...
bool maple_lightgun::get_lightgun_pos()
{
	PlainJoystickState pjs;
	config->GetInput(&pjs);
	int x, y;
...
/*
	Atomiswave Lightgun
*/
u32 atomiswave_lightgun::transform_kcode(u32 kcode) {
	mutualExclusion(kcode, AWAVE_UP_KEY | AWAVE_DOWN_KEY);
	mutualExclusion(kcode, AWAVE_LEFT_KEY | AWAVE_RIGHT_KEY);
...
/*
	Maracas Controller
*/
u32 maple_maracas_controller::get_capabilities() {
	// byte 0: 0  0  0  0  0  0  0  0
	// byte 1: 0  0  a5 a4 a3 a2 a1 a0
	// byte 2: R2 L2 D2 U2 D  X  Y  Z
	// byte 3: R  L  D  U  St A  B  C
...
u16 maple_maracas_controller::getButtonState(const PlainJoystickState &pjs) {
	return pjs.kcode | 0xf6f0;		// mask off DPad2, X, Y, DPad;
}

MapleDeviceType maple_maracas_controller::get_device_type() {
	return MDT_MaracasController;
}

u32 maple_maracas_controller::getAnalogAxis(int index, const PlainJoystickState &pjs) {
	if (index < 2 || index > 5)
		return 0;
...
const char *maple_maracas_controller::get_device_name() {
	return maple_maracas_controller_name;
}

u32 maple_maracas_controller::get_device_current(int get_max_current) {
...
/*
	Fishing Controller
*/
u32 maple_fishing_controller::get_capabilities() {
	// byte 0: 0  0  0  0  0  0  0  0
	// byte 1: 0  0  a5 a4 a3 a2 a1 a0
	// byte 2: R2 L2 D2 U2 D  X  Y  Z
	// byte 3: R  L  D  U  St A  B  C
...
u16 maple_fishing_controller::getButtonState(const PlainJoystickState &pjs)
{
...
MapleDeviceType maple_fishing_controller::get_device_type() {
	return MDT_FishingController;
}

u32 maple_fishing_controller::getAnalogAxis(int index, const PlainJoystickState &pjs)
{
...
const char *maple_fishing_controller::get_device_name() {
	return maple_fishing_controller_name;
}

u32 maple_fishing_controller::get_device_current(int get_max_current) {
...
*/
u32 maple_popnmusic_controller::get_capabilities() {
	// byte 0: 0  0  0  0  0  0  0  0
	// byte 1: 0  0  a5 a4 a3 a2 a1 a0
	// byte 2: R2 L2 D2 U2 D  X  Y  Z
	// byte 3: R  L  D  U  St A  B  C
...
u16 maple_popnmusic_controller::getButtonState(const PlainJoystickState &pjs) {
	return pjs.kcode | 0xf100; // mask off DPad2 and Z
}

MapleDeviceType maple_popnmusic_controller::get_device_type() {
	return MDT_PopnMusicController;
}

u32 maple_popnmusic_controller::getAnalogAxis(int index, const PlainJoystickState &pjs) {
	if (index == 0 || index == 1)
		return 0;		// Right and left triggers
	return 0x80;
}

const char *maple_popnmusic_controller::get_device_name() {
	return maple_popnmusic_controller_name;
}

u32 maple_popnmusic_controller::get_device_current(int get_max_current) {
...
/*
	Racing Controller
*/
u32 maple_racing_controller::get_capabilities() {
	// byte 0: 0  0  0  0  0  0  0  0
	// byte 1: 0  0  a5 a4 a3 a2 a1 a0
	// byte 2: R2 L2 D2 U2 D  X  Y  Z
	// byte 3: R  L  D  U  St A  B  C
...
u16 maple_racing_controller::getButtonState(const PlainJoystickState &pjs)
{
...
MapleDeviceType maple_racing_controller::get_device_type() {
	return MDT_RacingController;
}

u32 maple_racing_controller::getAnalogAxis(int index, const PlainJoystickState &pjs)
{
	switch (index)
	{
...
const char *maple_racing_controller::get_device_name() {
	return maple_racing_controller_name;
}

u32 maple_racing_controller::get_device_current(int get_max_current) {
...
/*
	Densha Controller
*/
u32 maple_densha_controller::get_capabilities() {
	// byte 0: 0  0  0  0  0  0  0  0
	// byte 1: 0  0  a5 a4 a3 a2 a1 a0
	// byte 2: R2 L2 D2 U2 D  X  Y  Z
	// byte 3: R  L  D  U  St A  B  C
...
u16 maple_densha_controller::getButtonState(const PlainJoystickState &pjs) {
	// Ra,La,Da,Ua are used together, corresponding to the brake lever.
	return pjs.kcode | 0xF000; // mask off DPad2
}

MapleDeviceType maple_densha_controller::get_device_type() {
	return MDT_DenshaDeGoController;
}

u32 maple_densha_controller::getAnalogAxis(int index, const PlainJoystickState &pjs) {
	if (index == 2 || index == 3)
		return 0;
...
const char *maple_densha_controller::get_device_name() {
	return maple_densha_controller_name;
}

u32 maple_densha_controller::get_device_current(int get_max_current) {
...
/*
	Full Controller
*/
u32 FullController::get_capabilities()
{
	// byte 0: 0  0  0  0  0  0  0  0
	// byte 1: 0  0  a5 a4 a3 a2 a1 a0
	// byte 2: R2 L2 D2 U2 D  X  Y  Z
...
u16 FullController::getButtonState(const PlainJoystickState &pjs)
{
	u32 kcode = pjs.kcode;
	mutualExclusion(kcode, DC_DPAD_UP | DC_DPAD_DOWN);
	mutualExclusion(kcode, DC_DPAD_LEFT | DC_DPAD_RIGHT);
...
u32 FullController::getAnalogAxis(int index, const PlainJoystickState &pjs)
{
	if (index == 4 || index == 5)
	{
		// Limit the magnitude of the analog axes to 128
...
const char *FullController::get_device_name() {
	return "Dreamcast PantherDC Controller";
}

MapleDeviceType FullController::get_device_type() {
	return MDT_SegaControllerXL;
}

/*
	Dream Para Para Controller
*/
u16 maple_dreamparapara_controller::unshift(u32 value)
{
	u16 result = 0;
...
MapleDeviceType maple_dreamparapara_controller::get_device_type()
{
	return MDT_DreamParaParaController;
}

u16 maple_dreamparapara_controller::get_state()
{
	u16 state = 0;
	PlainJoystickState pjs;
	config->GetInput(&pjs);
...
u32 maple_dreamparapara_controller::RawDma(const u32 *buffer_in, u32 buffer_in_len, u32 *buffer_out)
{
	u32 outlen = 0;
...
u32 RFIDReaderWriter::getStatus() const
{
	// b0: !card switch
	// b1: state=4	errors?
	// b2: state=5
...
u32 RFIDReaderWriter::RawDma(const u32 *buffer_in, u32 buffer_in_len, u32* buffer_out)
{
...
u32 RFIDReaderWriter::dma(u32 cmd)
{
	switch (cmd)
	{
	case MDC_DeviceRequest:
...
MapleDeviceType RFIDReaderWriter::get_device_type() {
	return MDT_RFIDReaderWriter;
}

void RFIDReaderWriter::OnSetup()
{
	memset(cardData, 0, sizeof(cardData));
	transientData = false;
}

std::string RFIDReaderWriter::getCardPath() const
{
	int playerNum;
...
void RFIDReaderWriter::loadCard()
{
	if (transientData)
		return;
...
void RFIDReaderWriter::saveCard() const
{
	if (transientData)
		return;
	std::string path = getCardPath();
...
void RFIDReaderWriter::serialize(Serializer& ser) const
{
...
void RFIDReaderWriter::deserialize(Deserializer& deser)
{
...
void RFIDReaderWriter::insertCard()
{
	if (!cardInserted) {
		cardInserted = true;
		loadCard();
...
const u8 *RFIDReaderWriter::getCardData() {
	loadCard();
	return cardData;
}

void RFIDReaderWriter::setCardData(u8 *data) {
