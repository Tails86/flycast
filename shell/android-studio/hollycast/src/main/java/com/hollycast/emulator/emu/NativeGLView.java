...
import com.hollycast.emulator.BaseGLActivity;
...
public class NativeGLView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom)
    {
        ...
        Log.i("hollycast", "Display density: " + dm.xdpi + " x " + dm.ydpi + " dpi. Refresh rate: " + d.getRefreshRate());
    ...
    public void surfaceChanged(SurfaceHolder surfaceHolder, int format, int w, int h) {
        Log.i("hollycast", "NativeGLView.surfaceChanged: " + w + "x" + h);
        surfaceReady = true;
    ...
    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        Log.i("hollycast", "NativeGLView.surfaceDestroyed");
        surfaceReady = false;
    ...
    public void pause() {
        paused = true;
        JNIdc.pause();
        Log.i("hollycast", "NativeGLView.pause");
    }

    public void resume() {
        if (paused) {
            Log.i("hollycast", "NativeGLView.resume");
            paused = false;
            setFocusable(true);
            setFocusableInTouchMode(true);
            requestFocus();
