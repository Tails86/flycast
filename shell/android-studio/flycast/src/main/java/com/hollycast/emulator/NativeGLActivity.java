...
import com.hollycast.emulator.emu.NativeGLView;
...
public final class NativeGLActivity extends BaseGLActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        Log.i("hollycast", "NativeGLActivity.onCreate");
    ...
    class ShowTextInputTask implements Runnable {
        ...
        public void run() {
            ...
            Log.d("hollycast", "ShowTextInputTask: run");
        }
    }
    ...
    public void hideTextInput() {
        Log.d("hollycast", "hideTextInput " + (mTextEdit != null ? "mTextEdit != null" : ""));
        if (mTextEdit != null) {
    ...
    class InputConnection extends BaseInputConnection {
        ...
        public boolean deleteSurroundingText(int beforeLength, int afterLength) {
            ...
            if (beforeLength > 0 && afterLength == 0) {
                Log.d("hollycast", "deleteSurroundingText before=" + beforeLength);
